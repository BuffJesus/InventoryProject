...
namespace FragmentTags
{
	...
	namespace Rarity
	{
		UE_DECLARE_GAMEPLAY_TAG_EXTERN(Rarity_Common)
		UE_DECLARE_GAMEPLAY_TAG_EXTERN(Rarity_Uncommon)
		UE_DECLARE_GAMEPLAY_TAG_EXTERN(Rarity_Rare)
		UE_DECLARE_GAMEPLAY_TAG_EXTERN(Rarity_Epic)
		UE_DECLARE_GAMEPLAY_TAG_EXTERN(Rarity_Legendary)
	}
}